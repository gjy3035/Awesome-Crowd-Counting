...
### Journal
- <a name="GNA"></a>**[GNA]** Video Crowd Localization with Multi-focus Gaussian Neighborhood Attention and a Large-Scale Benchmark (**TMM**)[[paper](https://ieeexplore.ieee.org/document/9875106)][[code]([https://github.com/dk-liang/FIDTM](https://github.com/HopLee6/VSCrowd-Dataset))]![GitHub stars](https://img.shields.io/github/stars/HopLee6/VSCrowd-Dataset.svg?logo=github&label=Stars) 
