...
- <a name="PAP"></a>**[PAP]** Harnessing Perceptual Adversarial Patches for Crowd Counting (**ACM CCS**) [[paper](https://arxiv.org/abs/2109.07986)] [[code](https://github.com/shunchang-liu/PAP-Pytorch)]![GitHub stars](https://img.shields.io/github/stars/shunchang-liu/PAP-Pytorch.svg?logo=github&label=Stars)
