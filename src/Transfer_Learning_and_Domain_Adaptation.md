...
- Neuron Linear Transformation: Modeling the Domain Shift for Crowd Counting (**TNNLS**) [[paper](https://arxiv.org/abs/2004.02133)]
...
- <a name="DACC"></a> **[DACC]** Domain-adaptive Crowd Counting via High-quality Image Translation and Density Reconstruction (**TNNLS**) [[paper](https://arxiv.org/abs/1912.03677)]
